...
def test_ksg_smoothed_discrete_uniform():
    """
    Test the KSG estimator on smoothed uniform distributions.
    """
    ...
    estimator_tester.run_tests(
        KSG,
        lambda mutual_information, X_dimension, Y_dimension: SmoothedDiscreteUniform(mutual_information, X_dimension),
        numpy.linspace(0.0, 2.0, 11),
        "Bad KSG estimates for smoothed discrete uniform distribution",
        range(1, 3),
        n_samples=10000,
        atol=0.1,
        rtol=0.05
